  ...
  useEffect(() => {
    async function loadGrades() {
      try {
        ...
        setGrades([
          { id: 'g1', marksObtained: 88, remarks: 'Excellent performance in Algebra', exam: { name: 'Term 1 Mid-Term Examination', maxMarks: 100, passingMarks: 33, subject: { name: 'Mathematics', code: 'MATH101' } } },
