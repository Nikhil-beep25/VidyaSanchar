  ...
  return (
    <div className="space-y-6">
      <div className="text-left">
        <h1 className="text-2xl font-bold tracking-tight">Child Tuition Dues</h1>
        <p className="text-sm text-muted-foreground">Monitor quarterly bills and payment records.</p>
      </div>
